...
public abstract class CaptchaFragmentBuilder {
   ...
   protected CaptchaFragment fragment;
    ...
    public CaptchaFragmentBuilder withCustomTextAppearance(int customTextAppearance) {
        args.putInt(CaptchaFragment.ARG_CUSTOM_TEXT_APPEARANCE, customTextAppearance);
        return this;
    }

    public CaptchaFragmentBuilder withCustomImage(int customImage) {
        args.putInt(CaptchaFragment.ARG_CUSTOM_IMAGE, customImage);
        return this;
    }
